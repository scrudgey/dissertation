...
% More precise uncertainties on the values of $t_D$, $t_F$, and $t_Q$ could be obtained by incorporating uncertainty in rest-frame colors through Monte Carlo simulations.
% Uncertainty in rest-frame color would shuffle galaxies between the RGB categories, and is expected to be largest in the star-forming and intermediate populations
