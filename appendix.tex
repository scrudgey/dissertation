...
\startdata
1  & J003442-430752 & 14 & MLE & $-0.041\substack{+0.043 \\ -0.044} $ & $0.067\substack{+0.024 \\ -0.017}$ & $1.211\substack{+0.026 \\ -0.023}$ & $0.3720\substack{+0.026 \\ -0.023}$ \\[1.25ex]
...
\tablewidth{0pt}
\tablehead{
\colhead{Sample} & \colhead{N} & \colhead{$\bar{z}$} & \colhead{Quiescent} & \colhead{Star-Forming} & \colhead{UVJ ${t_Q}^a$ (Gyr)} & \colhead{RGB ${t_Q}^b$ (Gyr)}
}
\startdata
